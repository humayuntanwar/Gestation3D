...
import java.util.ArrayList;
 ...
 public class DietsRetriever extends Adapter<DietsRetriever.DataObjectHolder> implements OnClickListener {
    ArrayList<DietsDataModel> Show;
    ...
    public DietsRetriever(Activity activity2, ArrayList<DietsDataModel> contacts) {
