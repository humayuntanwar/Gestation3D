...
import java.util.ArrayList;
 ...
 public class DbRetrieveAdapter extends Adapter<DbRetrieveAdapter.DataObjectHolder> implements OnClickListener {
    ...
    public DbRetrieveAdapter(Activity activity2, ArrayList<TwodDataModel> contacts) {
